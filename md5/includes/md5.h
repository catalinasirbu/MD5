...
public:
  ...
  /// @warning Must be 8bit
  typedef unsigned char uint1;

  /// @warning Must be 32 bit
  typedef unsigned int uint4;

  /// @brief To track progress
  bool finalized;
  ...
  /// @brief Default constructor - just initialize
  MD5();
  ...
  /// @brief Apply MD5 also on a block
  ...
  friend std::ostream& operator<<(std::ostream&, MD5 md5);
	...
	/**
	*  \defgroup @name F, G, H, I, FF, GG, HH and II functions
